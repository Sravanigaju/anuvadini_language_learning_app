...
router.patch("/:userId/coins", userProfileController.updateUserCoins); //curl -X PATCH http://localhost:3000/api/userprofile/<USER_ID>/coins \  -H "Content-Type: application/json" \ -d '{"action": "increase", "amount": 20}'
