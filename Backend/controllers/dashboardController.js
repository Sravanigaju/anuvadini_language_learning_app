...
exports.getUserDashboard = async (req, res) => {
  try {
    ...
    return res.status(200).json({
      ...
      daily_goal: userProfile.dailyGoal || 0,
      motivation: userProfile.motivation || "",
      interested_languages: userProfile.interestedLanguages || [],
      badges: userProfile.dashboardStats?.badgesEarned || [],
      last_active_at: userProfile.dashboardStats?.lastActiveAt || null,
      total_time_spent: userProfile.dashboardStats?.totalTimeSpent || 0,
    });
